jQuery(document).ready(function() {
  ...
  $("#clickable_gif").click(function(){
    console.log("dont click me");
    this.src="images/camera.gif";
    setTimeout(function() {

      $("#clickable_gif").attr('src', 'images/camera_still.jpg');

    }, 4000);
  });

  new alienEye(3,-335,16,'cursorEyes');
  new alienEye(-83,-335,16,'cursorEyes');
  //  follow cursor below from http://userbag.co.uk/development/javascript-eyes-that-follow-the-cursor/
